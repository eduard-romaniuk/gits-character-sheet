(function (Sheet) {
  ...
  // Small inline line-icon set (no external assets/CDN — this is a no-build static
  // app). Standard minimal shapes (pencil/copy/download/x), sized via CSS on `.icon svg`.
  Sheet.ICONS = {
    ...
    delete: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>',
  };
